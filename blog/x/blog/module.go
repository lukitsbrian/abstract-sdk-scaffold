...
import (
	...
	"github.com/lukitsbrian/abstract-sdk-scaffold/blog/x/blog/client/cli"
	"github.com/lukitsbrian/abstract-sdk-scaffold/blog/x/blog/client/rest"
...
// RegisterCodec registers the blog module's types for the given codec.
...
// RegisterRESTRoutes registers the REST routes for the blog module.
...
// Route returns the message routing key for the blog module.
func (AppModule) Route() string {
	return types.RouterKey
}

// NewHandler returns an sdk.Handler for the blog module.
func (am AppModule) NewHandler() sdk.Handler {
	return NewHandler(am.keeper)
}

// QuerierRoute returns the blog module's querier route name.
func (AppModule) QuerierRoute() string {
	return types.QuerierRoute
}

// NewQuerierHandler returns the blog module sdk.Querier.
...
// BeginBlock returns the begin blocker for the blog module.
func (am AppModule) BeginBlock(ctx sdk.Context, req abci.RequestBeginBlock) {
	BeginBlocker(ctx, req, am.keeper)
}

// EndBlock returns the end blocker for the blog module. It returns no validator
// updates.
